...
function asynchronous() {
    ...
    <input type="text" size=10 name="selectPosition"
           value="<%=ReloadableConfiguration.getInstance().getSelectPosition()%>">
    <input type="button" value="confirm" onclick="javascript:selectP();"/></td><td><ol
        class="left"><pre><b>&nbsp;&nbsp;Select Position means :</b><br>&nbsp;&nbsp;&nbsp;&nbsp;shows your SQL change logging position. <br>&nbsp;&nbsp;&nbsp;&nbsp;If you change value "false" then log will starting [Position Check Start: ...] like below. <br>&nbsp;&nbsp;&nbsp;&nbsp;This is only affected 'INSERT, UPDATE, DELETE' query. </pre></ol></td></tr><tr><td
    ...
    <input type="text" size=10 name="noneSelectPosition"
           value="<%=ReloadableConfiguration.getInstance().getNoneSelectPosition()%>">
    <input type="button" value="confirm" onclick="javascript:noneSP();"/></td><td><ol
        class="left"><pre><b>&nbsp;&nbsp;query.logging.position.none_select means :</b><br>&nbsp;&nbsp;&nbsp;&nbsp;same upper in insert, update, delete. </pre></ol></td></tr><tr><td
       ...
       <tr>
            ...
            <td>&nbsp;&nbsp;
                ...
                <input type="button" value="confirm"
                       onclick="javascript:viewAppoint();"/>
            </td>
            <td><ol class="left">
